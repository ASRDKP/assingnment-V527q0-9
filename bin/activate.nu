...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/rahulprajapat/.local/share/virtualenvs/assingnment-V527q0-9'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('assingnment' == '') {
...
alias deactivate = source '/Users/rahulprajapat/.local/share/virtualenvs/assingnment-V527q0-9/bin/deactivate.nu'
